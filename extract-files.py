...
blob_fixups: blob_fixups_user_type = {
    'vendor/etc/display/qdcm_calib_data_td4328_video_mode_dsi_panel_without_DSC.json': blob_fixup()
        .regex_replace('nt35532_video_mode_dsi_panel_without_DSC', 'td4328_video_mode_dsi_panel_without_DSC'),
